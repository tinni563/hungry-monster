const createMealInfoDiv = (meal, mealInput) => {
    ...
    <div onclick="getMealDetails(${meal.idMeal})" class="card border-0 shadow cursor" style="width: 14rem; border-radius: 10px">
    <img src ="${mealPhoto}" class="card-img-top" style="width: 14px; border-radius: 10px 10px 0 0">
    <div class="card-body">
...
const showMealDetailsDiv = data =>{
    ...
    const mealDetailsSection =document.getElementById("meal-details-section");
    mealDetailsSection.innerHTML =`
    <div id="meal-details" class="card px-0 pb-1 border-0 shadow col-xm-12 col-md-6" style="border-radius: 10px;">
    <img src ="${mealPhoto}" class="card-img-top" style="border-radius: 10px 10px 0 0;">
    <div id = "card-body">
    <h2 class="card-title text-center my-3">${mealName}</h2>
    <hr>
    <h5 calss ="card-title mt-4">Meal Ingredients</h5>
